...
pub static INSTRUCTIONS: [Instruction; 256] = [
    ...
    Instruction {name:  ASL, mode: Accumulator, category: Register, is_unofficial: false, operation: arithmetic_shift_left_accumulator},
    ...
    Instruction {name:  ROL, mode: Accumulator, category: Register, is_unofficial: false, operation: rotate_left_accumulator},
    Instruction {name: ANC, mode: Immediate,   category: Unimplemented, is_unofficial: true, operation: none},
    ...
    Instruction {name:  LSR, mode: Accumulator, category: Register, is_unofficial: false, operation: logical_shift_right_accumulator},
    ...
    Instruction {name:  ROR, mode: Accumulator, category: Register, is_unofficial: false, operation: rotate_right_accumulator},
