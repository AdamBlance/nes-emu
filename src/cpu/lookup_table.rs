...
pub static INSTRUCTIONS: [Instruction; 256] = [
    ...
    Instruction {name: NOP, mode: ZeroPage,    category: Unimplemented, is_unofficial: true},
    ...
    Instruction {name: NOP, mode: Absolute,    category: Unimplemented, is_unofficial: true},
    ...
    Instruction {name: NOP, mode: ZeroPageX,   category: Unimplemented, is_unofficial: true},
    ...
    Instruction {name: NOP, mode: Implied,     category: Unimplemented, is_unofficial: true},
    Instruction {name: SLO, mode: AbsoluteY,   category: Unimplemented, is_unofficial: true},
    Instruction {name: NOP, mode: AbsoluteX,   category: Unimplemented, is_unofficial: true},
    ...
    Instruction {name: NOP, mode: Immediate,   category: Unimplemented, is_unofficial: true},
