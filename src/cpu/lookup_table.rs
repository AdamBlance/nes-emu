...
pub enum Name {
    ...
    RLA, RRA, SLO, SRE, XAA, JAM, ISB, SBX,
}
...
pub static INSTRUCTIONS: [Instruction; 256] = [
    ...
    Instruction {name: NOP, mode: Immediate,   category: Imm, is_unofficial: true, operation: none},
    Instruction {name: ISB, mode: IndirectX,   category: ReadModifyWrite, is_unofficial: true, operation: isb},
    ...
    Instruction {name: ISB, mode: ZeroPage,    category: ReadModifyWrite, is_unofficial: true, operation: isb},
    ...
    Instruction {name: ISB, mode: Absolute,    category: ReadModifyWrite, is_unofficial: true, operation: isb},
    // F
    ...
    Instruction {name: JAM, mode: Implied,     category: NonMemory, is_unofficial: true, operation: jam},
    Instruction {name: ISB, mode: IndirectY,   category: ReadModifyWrite, is_unofficial: true, operation: isb},
    Instruction {name: NOP, mode: ZeroPageX,   category: Read, is_unofficial: true, operation: none},
    ...
    Instruction {name: ISB, mode: ZeroPageX,   category: ReadModifyWrite, is_unofficial: true, operation: isb},
    ...
    Instruction {name: NOP, mode: Implied,     category: NonMemory, is_unofficial: true, operation: none},
    Instruction {name: ISB, mode: AbsoluteY,   category: ReadModifyWrite, is_unofficial: true, operation: isb},
    Instruction {name: NOP, mode: AbsoluteX,   category: Read, is_unofficial: true, operation: none},
    ...
    Instruction {name: ISB, mode: AbsoluteX,   category: ReadModifyWrite, is_unofficial: true, operation: isb},
];
