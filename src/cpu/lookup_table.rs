...
pub static INSTRUCTIONS: [Instruction; 256] = [
    ...
    Instruction {name: NOP, mode: ZeroPage,    category: NoOp, is_unofficial: true},
    ...
    Instruction {name: NOP, mode: Absolute,    category: NoOp, is_unofficial: true},
    ...
    Instruction {name: NOP, mode: ZeroPageX,   category: NoOp, is_unofficial: true},
    ...
    Instruction {name: NOP, mode: Implied,     category: NoOp, is_unofficial: true},
    Instruction {name: SLO, mode: AbsoluteY,   category: Unimplemented, is_unofficial: true},
    Instruction {name: NOP, mode: AbsoluteX,   category: NoOp, is_unofficial: true},
    ...
    // 8
    Instruction {name: NOP, mode: Immediate,   category: NoOp, is_unofficial: true},
    ...
    Instruction {name:  NOP, mode: Implied,     category: NoOp, is_unofficial: false},
